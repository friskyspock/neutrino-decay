...
ROOT.gSystem.AddIncludePath("-I/home/student03/tools/madGraph/ExRootAnalysis");
ROOT.gSystem.AddIncludePath("-I/home/student03/tools/madGraph/Delphes");

try:
    ROOT.gInterpreter.Declare('#include "/home/student03/tools/madGraph/ExRootAnalysis/ExRootAnalysis/ExRootTreeReader.h"')
    ROOT.gInterpreter.Declare('#include "/home/student03/tools/madGraph/Delphes/classes/DelphesClasses.h"')
except:
    pass
...
class GenDataset:
    ...
    def create_arrays(self):
        ...
        #treeReader = ROOT.ExRootTreeReader(root_file)
        ...
        for i in range(self.total_events):
            ...
            ra_angle = [] # Rapidity
            jet_info = [] # Info of the Jets for reconstruction
            ptl = 0
            ptj = 0
            ptg = 0
            ptt = 0
            ...
            event_dict.append({"fourMomenta" : ep_array,"azimuthalAngle" : ez_array,
                              "phiList" : az_angle,"etaList" : ra_angle,"jetInfo" : jet_info})
...
if __name__ == "__main__":
    ...
    s1 = GenDataset()
    s1.load_from_root_file('/home/student03/neutrinoDecay/results/ppToww/Events/run_01/tag_1_delphes_events.root')
    ...
    #s1.sanitize_data()
    #s1.create_dataset('/home/student03/higgsSelfCoupling/datasets/sanitize/'+i+'_5M.h5')
    ...
    print(s1.dataset_dict[0]['jetInfo'])
